...
class BasketServiceImplTest {
    ...
    @Test
    void testGetTotalAmount_BasketNotFound() {
        when(basketRepository.findByUserId(1L)).thenReturn(Optional.empty());

        assertThrows(NotFoundException.class, () -> basketService.getTotalAmount());
    }

    @Test
    void testGetTotalAmount_UserNotFound() {
        Basket basket = new Basket();
        basket.setId(1L);
    ...
    @Test
    void testGetBasketSummary_BasketNotFound() {
        when(basketRepository.findByUserId(1L)).thenReturn(Optional.empty());

        assertThrows(NotFoundException.class, () -> basketService.getBasketSummary());
    }

    @Test
    void testGetBasketSummary_UserNotFound() {
        Basket basket = new Basket();
        basket.setId(1L);
    ...
    @Test
    void testCalculateRawTotalAmount_BasketNotFound() {
        when(basketRepository.findByUserId(1L)).thenReturn(Optional.empty());
